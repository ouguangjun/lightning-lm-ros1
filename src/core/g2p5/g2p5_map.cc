...
nav_msgs::OccupancyGrid G2P5Map::ToROS() {
    ...
    occu_map.info.resolution = static_cast<nav_msgs::MapMetaData::_resolution_type>(options_.resolution_);
    occu_map.info.width = static_cast<nav_msgs::MapMetaData::_width_type>(image_width);
    occu_map.info.height = static_cast<nav_msgs::MapMetaData::_width_type>(image_height);
